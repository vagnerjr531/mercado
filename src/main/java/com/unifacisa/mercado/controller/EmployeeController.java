...
public class EmployeeController {
	...
	@PutMapping("/{employeeId}/change-manager/{managerId}")
	public ResponseEntity<Employee> changeManager(
	        @PathVariable Long employeeId,
	        @PathVariable Long managerId) {
	    
	    Employee updatedEmployee = employeeService.changeManager(employeeId, managerId);
